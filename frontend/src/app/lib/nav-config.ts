 ...
 * exactly once.
 *
 * Groups mirror the sidebar at https://docs.copilotkit.ai/angular/google-adk as of
 ...
 */
export const DOCS_ROOT = 'https://docs.copilotkit.ai/angular/google-adk';
...
export const NAV: NavGroup[] = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        hasDemo: true,
        title: 'Quickstart',
        docPath: '/angular/google-adk/quickstart',
        summary:
          'The smallest end-to-end path: an HttpAgent bound to the ADK backend in Copilot Runtime, provideCopilotKit, and one copilot-chat.',
        status: 'working',
      },
    ],
  },
    ...
    routes: [
      {
        ...
        docPath: '/angular/google-adk/guides/chat-ui',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/google-adk/guides/frontend-tools-generative-ui',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/google-adk/guides/a2ui',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/google-adk/guides/voice-multimodal',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/google-adk/guides/human-in-the-loop',
        summary:
      ...
      },
      {
        ...
        docPath: '/angular/google-adk/guides/shared-state',
        summary:
    ...
    routes: [
      {
        ...
        hasDemo: true,
        title: 'Threads',
        docPath: '/angular/google-adk/guides/threads-memory-attachments-headless',
        summary:

 ...
 *
 * `registerRenderToolCall` — the tool runs on the server (the Google ADK
 * agent's `getWeather` tool) and the browser only renders its call, through
 ...
 *
 * https://docs.copilotkit.ai/angular/google-adk/guides/frontend-tools-generative-ui
 */
